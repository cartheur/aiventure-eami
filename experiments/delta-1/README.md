## Heiserman, in _Modern Electronics_, March 1978, Issue 2:

_Problem statement_

What is needed are dynamic, self-programming, general-purpose machines capable of setting and pursuing their own goals in the context of the world as _the machines, themselves, perceive it_. There, in it, we can state:

_Problem exploaration_

Dynamic (existence.Step()) self-programming machines (animals) capable (IExistence) of setting (existence0xx) and pursuing (interaction) their own goals (Experiment) in the context (Result) of the world as they-themselves perceive it.
