10 REM •* BETA CONL COMP- I ** 
15 DIMM( trit 5t 3 )ZGOSUB500
20 CLS:FORNis ITO5 :FORlialT05:POROalT021MOWIFO :NEx T0,01,4
25 FORNst1T045:FORM 1T015:M(MtN73)*I004EXTM,N:GOSUb604
30 GOSUB550
...
70 GOTO35
200 REM ** BETA CONL-1 **
205 MI=I+3:MJ=J+3:KL=1.1( MIN:3 )SIFKL=OTHEN235
210 RI=M(Plittthl ):RJ=1.1( MIftlJr2
215 I=RI-3:J=RJ-3:GOSUB725
220 IFC0=0THEN240
225 C=C44:IFKL=OTHEN235
230 KL=KL-1:G0T0215
235 GOSUB450:GOSUB650:KL=1:G0T0215
...
550 REM ** FIELD-2 **
552 F1=15553:F2=15615F3 16193F4=16255
